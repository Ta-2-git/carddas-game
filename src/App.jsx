...
// ===== 3Dモデルコンポーネント =====
const CharacterModel3D = ({ modelPath, animState = "idle", isEnemy = false, size = 110 }) => {
...
const CharacterFighter = ({ card, animState, isEnemy = false, size = 110, scale = 1 }) => {
  ...
  if (modelPath) {
    return <CharacterModel3D modelPath={modelPath} animState={animState} isEnemy={isEnemy} size={size} />;
  }
