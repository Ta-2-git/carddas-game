...
export default function App() {
  ...
  return (
    <>
      <style>{`
        @keyframes titlePulse { 0%,100%{text-shadow:0 0 40px #f59e0b, 0 0 80px #f59e0b44} 50%{text-shadow:0 0 60px #f59e0b, 0 0 120px #f59e0b66, 0 0 160px #f59e0b22} }
        @keyframes rayRotate { from{transform:rotate(0deg)} to{transform:rotate(360deg)} }
        @keyframes cardAppear { 0%{opacity:0;transform:scale(0.3) translateY(60px) rotateZ(-10deg)} 60%{opacity:1;transform:scale(1.05) translateY(-5px) rotateZ(2deg)} 100%{opacity:1;transform:scale(1) translateY(0) rotateZ(0)} }
        ...
        @keyframes winBounce { from{transform:translateY(0) rotate(-5deg)} to{transform:translateY(-10px) rotate(5deg)} }
        ...
        @keyframes atkUpIn { 0%{opacity:0;transform:scale(0) rotate(-12deg)} 60%{opacity:1;transform:scale(1.1)} 100%{opacity:1;transform:scale(1)} }
        ...
        @keyframes dragonBurstIn { 0%{opacity:0;transform:scale(0.2) rotate(-8deg)} 50%{opacity:1;transform:scale(1.08) rotate(1deg)} 100%{opacity:1;transform:scale(1)} }
        ...
        @keyframes sparkRay { 0%{transform:translate(0,-50%) rotate(var(--deg,0deg)) scaleX(0.6);opacity:0.6} 100%{transform:translate(0,-50%) rotate(var(--deg,0deg)) scaleX(1.2);opacity:1} }
        @keyframes particle0 { 0%{transform:translate(-50%,-50%) rotate(0deg) translateX(8px) scale(1);opacity:1} 100%{transform:translate(-50%,-50%) rotate(360deg) translateX(30px) scale(0);opacity:0} }
        @keyframes particle1 { 0%{transform:translate(-50%,-50%) rotate(0deg) translateX(6px) scale(1);opacity:1} 100%{transform:translate(-50%,-50%) rotate(-360deg) translateX(26px) scale(0);opacity:0} }
        @keyframes particle2 { 0%{transform:translate(-50%,-50%) rotate(0deg) translateX(10px) scale(1);opacity:1} 100%{transform:translate(-50%,-50%) rotate(270deg) translateX(34px) scale(0);opacity:0} }
        ...
        @keyframes cutInTitleSlide { 0%{opacity:0;transform:translateY(-60px)} 100%{opacity:1;transform:translateY(0)} }
        ...
        @keyframes cardShine { 0%{left:-60%} 100%{left:120%} }
        ...
        @keyframes kiEnter { 0%{transform:translateX(-50%) translateY(-280px) scale(0.6);opacity:0} 20%{opacity:1;transform:translateX(-50%) translateY(-200px) scale(1)} 80%{opacity:1;transform:translateX(-50%) translateY(-10px) scale(1.1)} 100%{transform:translateX(-50%) translateY(0px) scale(1.3);opacity:0.8} }
        ...
        @keyframes scouterScan { 0%{top:-4px} 100%{top:100%} }
        ...
        @keyframes eventCutIn { 0%{opacity:0;transform:scale(0.3) translateY(40px)} 60%{opacity:1;transform:scale(1.05) translateY(-4px)} 100%{opacity:1;transform:scale(1) translateY(0)} }
